 ...
 */
[Native(amd="ext-as.module", "chart.Chart")]
public class Chart extends FlashComponent {
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.chart.Chart-property-CHART_URL Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.chart.Chart-method-bindStore Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.chart.Chart-method-setSeriesStyles Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.chart.Chart-method-setStyle Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.chart.Chart-method-setStyles Sencha Docs Ext JS 3.4
   */
