 ...
 */
[Native(amd="ext-as.module", global="Ext.layout.BorderLayout.Region")]
public class Region {
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-property-isCollapsed Sencha Docs Ext JS 3.4
   */
  public native function get isCollapsed():Boolean;

  /**
   This region's layout.
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-property-layout Sencha Docs Ext JS 3.4
   */
  public native function get layout():ContainerLayout;

  /**
   This region's panel.
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-property-panel Sencha Docs Ext JS 3.4
   */
  public native function get panel():Panel;

  /**
   This region's layout position (north, south, east, west or center).
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-property-position Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-method-getMargins Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-method-getMinHeight Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-method-getMinWidth Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-method-getSize Sencha Docs Ext JS 3.4
   */
   ...
   *
   * @return
          * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-method-isVisible Sencha Docs Ext JS 3.4
   */
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-method-setPanel Sencha Docs Ext JS 3.4
   */
   ...
   *
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-method-slideIn Sencha Docs Ext JS 3.4
   */
   ...
   *
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.BorderLayout.Region-method-slideOut Sencha Docs Ext JS 3.4
   */
