 ...
 */
[Native(amd="ext-as.module", "layout.HBoxLayout")]
public class HBoxLayout extends BoxLayout {
   ...
   * @see http://docs.sencha.com/ext-js/3-4/#!/api/Ext.layout.HBoxLayout-method-calculateChildBoxes Sencha Docs Ext JS 3.4
   */
