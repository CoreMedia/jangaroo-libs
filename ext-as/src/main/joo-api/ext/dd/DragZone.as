 ...
 * provided implementation of <b class='link'>#getDragData</b>, or by registered draggables registered with <b class='link'>Ext.dd.Registry</b></p>
 ...
 * the DragZone with  an implementation of the <b class='link'>#getDragData</b> method which interrogates the passed
...
public function DragZone(el : *, config : Object) {
  super(el, config);
     ...
     * of the <b class='link'>#getDragData</b> method. It must contain a <tt>ddel</tt> property, but can contain
