...
public class JsonWriter extends DataWriter {
  public function JsonWriter(meta : Object, recordType : Object) {
    ...
    /**
     * @cfg {Boolean} encode <tt>true</tt> to <b class='link' title='Ext.util.JSON#encode'>encode</b> the
     * <b class='link' title='ext.data.DataWriter#toHash hashed'>data</b>. Defaults to <tt>true</tt>.  When using
     * <b class='link'>ext.data.DirectProxy</b>, set this to <tt>false</tt> since ext.Direct.JsonProvider will perform
     * its own json-encoding.  In addition, if you're using <b class='link'>ext.data.HttpProxy</b>, setting to <tt>false</tt>
