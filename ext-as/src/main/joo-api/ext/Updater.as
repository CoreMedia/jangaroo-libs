...
/**
 * Provides AJAX-style update capabilities for Element objects.  Updater can be used to <b class='link'>#update</b>
 * an <b class='link'>ext.Element</b> once, or you can use <b class='link'>#startAutoRefresh</b> to set up an auto-updating
 ...
 */
	     ...
	     * the default URL for this Updater object, and will be subsequently used in <b class='link'>#refresh</b>
	...
	um.update({
	    ...
	    /**
	     * Set this element to auto refresh.  Can be canceled by calling <b class='link'>#stopAutoRefresh</b>.
	     * @param interval How often to update (in seconds).
	     * @param url The url for this request, a config object in the same format
	     * supported by <b class='link'>#load</b>, or a function to call to get the url (defaults to the last used url).  Note that while
	    ...
	    /**
	     * Returns true if the Updater is currently set to auto refresh its content (see <b class='link'>#startAutoRefresh</b>), otherwise false.
	     */
	    public native function isAutoRefreshing() : void;
	    /**
	     * Display the element's "loading" state. By default, the element is updated with <b class='link'>#indicatorText</b>. This
