 ...
 * <p>In automatic mode, you simply call <b class='link' title='#wait'>wait</b> and let the progress bar run indefinitely, only clearing it
...
public class ProgressBar extends BoxComponent {
  public function ProgressBar(config : *) {
    ...
    */
     ...
     * determining when the progress is complete and calling <b class='link' title='#reset'>reset</b> to clear and/or hide the control.
     ...
     * be manually cleared by calling <b class='link' title='#reset'>reset</b>.  The wait method accepts a config object with
...
myAction.on('complete', function(){
    ...
    /**
     * Returns true if the progress bar is currently in a <b class='link' title='#wait'>wait</b> operation
     ...
     * on the current progress <b class='link' title='#value'>value</b>.  This will be called automatically when the ProgressBar
     ...
     * bar will also be hidden (using the <b class='link' title='#hideMode'>hideMode</b> property internally).
