...
public class LoaderInfo extends EventDispatcher {
  ...
  /**
   ...
   </p><p><b>Note:</b> This property always has a value of either <code>ActionScriptVersion.ACTIONSCRIPT2</code> or
  ...
  /*
   ...
   </p><p>All code in a SWF file is defined to exist in an application domain. The current application
  ...
  /**
   ...
   </p><p>Before the first <code>progress</code> event is dispatched by
  ...
  /**
   ...
   </p><p>For more information related to security, see the Flash Player Developer Center Topic:
   <a href="http://www.adobe.com/go/devnet_security_en" target="external">Security</a>.</p>
  ...
  /**
   ...
   in order to determine the type. The following list gives the possible values:</p>
   <ul>
  ...
  /**
   ...
   value is <code>true</code> only when all of the following are also true:</p>
   <ul>
  ...
  /**
   ...
   </p><p>You can use a <code>for-in</code> loop to extract all the names and values
  ...
  /**
   ...
   </p><br><br><span class="label"> Implementation </span><br><code>&nbsp;&nbsp;&nbsp;&nbsp;public function get sameDomain():Boolean</code><br><br><span class="label"> Throws </span><br><table border="0" cellpadding="0" cellspacing="0"><tbody><tr><td width="20"></td><td><code>Error </code> —  Thrown if the file is not downloaded sufficiently
   to retrieve the requested information.
   </td></tr></tbody></table></div></span><span style="" id="pageFilter" runtime="Flash::9##Lite::4##"><a name="propertyDetail"></a><a name="sharedEvents"></a><table class="detailHeader" cellpadding="0" cellspacing="0"><tbody><tr><td class="detailHeaderName"><h2>sharedEvents</h2></td><td class="detailHeaderType">property</td><td class="detailHeaderRule">&nbsp;</td></tr></tbody></table><div class="detailBody"><code>sharedEvents:EventDispatcher</code>&nbsp;&nbsp;[read-only] <p></p><table border="0" cellpadding="0" cellspacing="0"><tbody><tr><td style="white-space: nowrap;" valign="top"><b>Language Version:&nbsp;</b></td><td>ActionScript 3.0</td></tr></tbody></table><table border="0" cellpadding="0" cellspacing="0"><tbody><tr><td style="white-space: nowrap;" valign="top"><b>Runtime Versions:&nbsp;</b></td><td>AIR 1.0 Flash Player 9, Flash Lite 4</td></tr></tbody></table><p></p><p></p><p>
  ...
  /**
   ...
   </p><p>This property is created when the SWF associated with this LoaderInfo has finished
  ...
  /**
   ...
   </p><p>Before the first <code>progress</code> event is dispatched by this LoaderInfo
