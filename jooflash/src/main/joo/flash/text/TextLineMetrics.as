 ...
 * <p>
 * <img src="http://help.adobe.com/en_US/FlashPlatform/reference/actionscript/3/images/text-metrics.jpg" alt="An image illustrating text metrics" />
 * </p>
...
public class TextLineMetrics {
  ...
  /**
   * The x value is the left position of the first character in pixels. This value includes the margin, indent (if any),
   * and gutter widths. See the "Text Line x-position" in the overview diagram for this class.
   ...
   * The width of the text line is not the same as the width of the text field. The width of the text line is relative
   * to the text field width, minus the gutter width of 4 pixels (2 pixels on each side). See the "Text Line width"
   * measurement in the overview diagram for this class.
   * @see flash.text.TextLineMetrics
   */
  public var width:Number;
  /**
   * The height value of the text of the selected lines (not necessarily the complete text) in pixels. The height of
   * the text line does not include the gutter height. See the "Line height" measurement in the overview diagram for
   * this class.
   * @see flash.text.TextLineMetrics
   */
   ...
   * See the "Ascent" measurement in the overview diagram for this class.
   * @see flash.text.TextLineMetrics
   */
  ...
  /**
   * The leading value is the measurement of the vertical distance between the lines of text. See the "Leading"
   * measurement in the overview diagram for this class.
   * @see flash.text.TextLineMetrics
   */
   ...
   *
   * @see flash.text.TextLineMetrics
   * @see flash.text.TextField#getLineMetrics()
   *
   */
