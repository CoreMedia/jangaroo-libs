...
public class GridFitType {
   ...
   * This constant is used in setting the <code>gridFitType</code> property of the
   * TextField class. This is often a good setting for animation
   * or for large font sizes.
   * Use the syntax <code>GridFitType.NONE</code>.
   *
   ...
   * fields and acts like the <code>GridFitType.SUBPIXEL</code> constant in static
   * text. This setting generally provides the best readability for left-aligned text.
   * Use the syntax <code>GridFitType.PIXEL</code>.
   *
   * @see flash.text.TextField.gridFitType
   */
   ...
   * This constant is used in setting the <code>gridFitType</code> property of the
   * TextField class.
   * Use the syntax <code>GridFitType.SUBPIXEL</code>.
   *
   * @see flash.text.TextField.gridFitType
   */
