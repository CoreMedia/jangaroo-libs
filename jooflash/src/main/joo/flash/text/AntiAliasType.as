...
public class AntiAliasType {
   ...
   * This constant is used for the <code>antiAliasType</code> property in the TextField
   * class.
   * Use the syntax <code>AntiAliasType.ADVANCED</code>.
   *
   ...
   * This constant is used for the <code>antiAliasType</code> property in the TextField
   * class.
   * Use the syntax <code>AntiAliasType.NORMAL</code>.
   *
   * @see flash.text.TextField.antiAliasType
   */
