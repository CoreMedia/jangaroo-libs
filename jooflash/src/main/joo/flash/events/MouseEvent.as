...
public class MouseEvent extends Event {
  ...
  public function get stageX():Number {
    if (!stagePoint) {
      ...
      stagePoint = target.localToGlobal(localPoint);
    }
    return stagePoint.x;
  }
  ...
  public function MouseEvent(type:String, bubbles:Boolean = true, cancelable:Boolean = false, localX:Number = NaN, localY:Number = NaN, relatedObject:InteractiveObject = null, ctrlKey:Boolean = false, altKey:Boolean = false, shiftKey:Boolean = false, buttonDown:Boolean = false, delta:int = 0) {
    ...
    localPoint = isNaN(localX) || isNaN(localY) ? null : new Point(localX, localY);
  ...
  override public function clone():Event {
    ...
    mouseEvent.localPoint = localPoint;
    mouseEvent.stagePoint = stagePoint;
    return mouseEvent;
  }
   ...
   * @private
   */
  public var stagePoint:Point; // internally set by Stage
}
}
