 ...
 * target is on the display list or not.</p>
 * <p>This event has the following properties:</p>
 * <ul>
 * <li>bubbles	false</li>
 * <li>cancelable	false; there is no default behavior to cancel.</li>
 * <li>currentTarget	The object that is actively processing the Event object with an event listener.</li>
 * <li>target	Any DisplayObject instance with a listener registered for the activate event.</li>
 * </ul>
 */
 ...
 * <p>Defines the value of the type property of a deactivate event object.</p>
 * <p>Note: This event does not go through a "capture phase" and is dispatched directly to the target, whether the
 * target is on the display list or not.</p>
 * <p>This event has the following properties:</p>
 * <ul>
 ...
 * <li>cancelable	false; there is no default behavior to cancel.</li>
 * <li>currentTarget	The object that is actively processing the Event object with an event listener.</li>
 * <li>target	Any DisplayObject instance with a listener registered for the deactivate event.</li>
 * </ul>
 */
 ...
 * return trip to the root of the display list.</p>
...
public class EventDispatcher extends Object implements IEventDispatcher {
   ...
   * IEventDispatcher interface, use this constructor to aggregate an instance of the EventDispatcher class.</p>
