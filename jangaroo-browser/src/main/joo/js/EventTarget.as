...
public class EventTarget {
  public native function EventTarget();
   ...
   * value is BUBBLING_PHASE. When false (or not present), callback will not be invoked when event's eventPhase attribute value is CAPTURING_PHASE. Either way, callback will be invoked if event's eventPhase attribute value is AT_TARGET.
   *
   ...
   */
  public native function addEventListener(type: String, listener: *, options: * = undefined): void;
   ...
   */
  public native function removeEventListener(type: String, callback: *, options: * = undefined): void;
}
}
