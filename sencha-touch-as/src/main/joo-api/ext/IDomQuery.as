...
public interface IDomQuery {
   ...
   * @see http://dev.sencha.com/deploy/ext-3.3.1/docs/source/DomQuery.html#method-Ext.DomQuery-select Ext JS source
   */
  function select(selector:String, root:* = null):Array;
   ...
   */
  function selectNode(selector:String, root:Node = null):HTMLElement;
