...
public class BelongsToAssociation extends Association {
   ...
   * @see http://dev.sencha.com/deploy/ext-3.3.1/docs/source/BelongsToAssociation.html#method-Ext.data.BelongsToAssociation-createGetter Ext JS source
   */
  public native function createGetter():Function;

  /**
   *
   *
   * @return The setter function
   * @see http://dev.sencha.com/deploy/ext-3.3.1/docs/source/BelongsToAssociation.html#method-Ext.data.BelongsToAssociation-createSetter Ext JS source
   */
  public native function createSetter():Function;
