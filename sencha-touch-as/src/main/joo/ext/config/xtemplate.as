 ...
 * typed config object for constructor of class XTemplate.</p>
 *
...
public class xtemplate extends template {
  ...
  public function xtemplate(config:Object = null) {
   ...
   * @private
   */
  public native function set codeRe(value:RegExp):void;
